...
const count = useSelector((state) => state.counter.value)
  return (
    ...
    //                   <div className="col-lg-12">
    //                     <div className="form_group">
    //                       {/* <Link to={{pathname:"/how-work"}}> */}
    //                         <button onClick={(e)=>{setRoutingData({dd:"dd"},"123")}} className="main-btn">Send Message</button>
    //                       {/* </Link> */}
    //                     </div>
    //                   </div>
    //                 </div>
    ...
    <div>
      ...
      <button onClick={() => dispatch(incrementByValue(2))}>{count}</button>
