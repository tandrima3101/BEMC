      ...
      <div className="service">
        <div className="container-fluid light-bg pt-4 pb-4">
          <div className="row">
              ...
              <div className="booking-card p-3">
                <div className="row">
                  <div className="col-lg-8">
                    <div className="row">
                      <div className="col-lg-4 bookingimagecss">
                        <img
                          src="https://images.unsplash.com/photo-1566159266489-6158a42c3beb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"
                          alt="bookedshow"
                      ...
                      <div className="col-lg-8 pl-0">
                        <div className="ticket-details">
                          ...
                          <p className="m-0">
                            <i className="ti-time mr-2"></i>time
                          </p>
                          <p className="m-0 mb-2">
                            <i className="ti-calendar mr-2"></i>date
                          </p>
                          <h6>
            ...
            <div className="ratingsstyle col-lg-3">
