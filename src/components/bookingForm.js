...
function BookingForm(props) {
  ...
  ///ambulance
  let journeyDetails = [];
  for(let i=0;i<props.data[0].price.length;i++){
    console.log(props.data[0].price[i],'baaaaaaaaaaaaaaaaaaaal')
    journeyDetails.push({
      label:`${props.data[0].price[i].key},Price:${props.data[0].price[i].value},(${props.data[0].price[i].extraPrice} Rs will be charged for extra ${props.data[0].price[i].thresholdKm} km)`,
      value:`${props.data[0].price[i].value},${props.data[0].price[i].key}`,
      key:`${props.data[0].price[i].key}`
    })
  }
            ...
            >
              <div className="row">
                ...
                <div className="col-lg-12 col-md-6 mt-2">
                  ...
                  <Select options={journeyDetails} onChange={(e) => { setBookingDetails({ ...bookingDetails, journey: e.value }) }} />
                </div>
                <div className="col-lg-12 col-md-6 mt-2">
                  <label>Date</label>
                  <input
                ...
                <div className="col-lg-12 col-md-6 mt-2 d-flex justify-content-start align-items-center">
                  <input type="checkbox" style={{ maxWidth: "4%" }} onChange={(e)=>setBookingDetails({...bookingDetails,emergency:e.target.value})}/>
